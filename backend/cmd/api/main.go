...
func main() {
	...
	adminHandler := handlers.NewAdminHandler(venueRepo, guideRepo, userRepo, auditRepo, verifLogRepo, reviewRepo, loginRepo, schedulerSvc, cfg.VerificationPeriodDays)
