...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,address,city,district,latitude,longitude,googlePlaceId,notes,status,rejectionNote,addedBy,addedByName,approvedBy,verifiedAt,verificationDueAt,foodHalalMode,const DeepCollectionEquality().hash(excludedProducts),const DeepCollectionEquality().hash(criteria),const DeepCollectionEquality().hash(photos),const DeepCollectionEquality().hash(foodItems),avgRating,reviewCount,distance,categoriesStr,createdAt,updatedAt]);
