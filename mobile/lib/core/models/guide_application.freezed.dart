...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,status,note,reviewedBy,reviewedAt,userName,userEmail,createdAt);

@override
String toString() {
  return 'GuideApplication(id: $id, userId: $userId, status: $status, note: $note, reviewedBy: $reviewedBy, reviewedAt: $reviewedAt, userName: $userName, userEmail: $userEmail, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId, String status, String? note,@JsonKey(name: 'reviewed_by') String? reviewedBy,@JsonKey(name: 'reviewed_at') DateTime? reviewedAt,@JsonKey(name: 'user_name') String? userName,@JsonKey(name: 'user_email') String? userEmail,@JsonKey(name: 'created_at') DateTime? createdAt
});
...
/// Create a copy of GuideApplication
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? status = null,Object? note = freezed,Object? reviewedBy = freezed,Object? reviewedAt = freezed,Object? userName = freezed,Object? userEmail = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String status,  String? note, @JsonKey(name: 'reviewed_by')  String? reviewedBy, @JsonKey(name: 'reviewed_at')  DateTime? reviewedAt, @JsonKey(name: 'user_name')  String? userName, @JsonKey(name: 'user_email')  String? userEmail, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GuideApplication() when $default != null:
return $default(_that.id,_that.userId,_that.status,_that.note,_that.reviewedBy,_that.reviewedAt,_that.userName,_that.userEmail,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String status,  String? note, @JsonKey(name: 'reviewed_by')  String? reviewedBy, @JsonKey(name: 'reviewed_at')  DateTime? reviewedAt, @JsonKey(name: 'user_name')  String? userName, @JsonKey(name: 'user_email')  String? userEmail, @JsonKey(name: 'created_at')  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _GuideApplication():
return $default(_that.id,_that.userId,_that.status,_that.note,_that.reviewedBy,_that.reviewedAt,_that.userName,_that.userEmail,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId,  String status,  String? note, @JsonKey(name: 'reviewed_by')  String? reviewedBy, @JsonKey(name: 'reviewed_at')  DateTime? reviewedAt, @JsonKey(name: 'user_name')  String? userName, @JsonKey(name: 'user_email')  String? userEmail, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _GuideApplication() when $default != null:
return $default(_that.id,_that.userId,_that.status,_that.note,_that.reviewedBy,_that.reviewedAt,_that.userName,_that.userEmail,_that.createdAt);case _:
  return null;
...
/// Create a copy of GuideApplication
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? status = null,Object? note = freezed,Object? reviewedBy = freezed,Object? reviewedAt = freezed,Object? userName = freezed,Object? userEmail = freezed,Object? createdAt = freezed,}) {
